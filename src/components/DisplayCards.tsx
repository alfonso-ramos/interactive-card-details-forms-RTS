    ...
    return (
        <><div className="bg-mobile h-[240px] bg-no-repeat bg-cover  xl:bg-desktop">
            <div className="max-w-[343px]">
                <div className="bg-card-back bg-cover bg-no-repeat w-[286px] h-[157px] absolute right-4 mt-8">
                    <p className="absolute right-9 top-[70px] text-xs text-white">{cvv || '000'}</p>
                </div>

                <div className="bg-card-front bg-cover bg-no-repeat w-[286px] h-[157px] absolute left-4 top-[120px]">
                    <img
